<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Career (Carrera) -->
        <div class="mt-4">
            <x-input-label for="career_id" :value="__('Carrera')" />
            <select id="career_id" name="career_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>

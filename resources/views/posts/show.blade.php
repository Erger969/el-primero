        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-7 xl:col-span-8 bg-white dark:bg-[#1e293b] rounded-3xl shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-800 flex flex-col animate-fade-in">
                ...
                <div class="p-6 lg:p-8 bg-gray-50 dark:bg-gray-800/40 border-t border-gray-100 dark:border-gray-800">
                    ...
                    @if(Auth::user()->role_id == 4)
                        <p class="text-sm font-medium text-red-500 mt-4 flex items-center gap-2">
                            <x-heroicon-s-no-symbol class="w-4 h-4" /> Las reacciones están restringidas en modo lectura.
                        </p>
                    @endif
                    </div>
                </div>
            ...
            <div class="lg:col-span-5 xl:col-span-4 flex flex-col h-[600px] lg:h-[calc(100vh-160px)] lg:sticky lg:top-28 bg-white dark:bg-[#1e293b] rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden animate-fade-in" style="animation-delay: 0.1s;">
                ...
                <div class="p-6 bg-gray-50 dark:bg-gray-800/40 border-t border-gray-100 dark:border-gray-800 z-10 shadow-[0_-10px_20px_-15px_rgba(0,0,0,0.1)]">
                    @auth
                        <div class="{{ Auth::user()->role_id == 4 ? 'opacity-60 grayscale' : '' }}">
                            <form action="{{ route('comments.store', $post) }}" method="POST">
                                ...
                                <div class="flex flex-col gap-3">
                                    <div class="flex gap-3">
                                        ...
                                        <textarea name="content" required placeholder="{{ Auth::user()->role_id == 4 ? 'Comentarios restringidos...' : 'Escribe tu comentario aquí...' }}" 
                                                rows="2" {{ Auth::user()->role_id == 4 ? 'disabled' : '' }}
                                    ...
                                    <button type="submit" {{ Auth::user()->role_id == 4 ? 'disabled' : '' }} class="self-end px-6 py-2.5 bg-gradient-to-r from-[#1A3C5E] to-[#2A6B9E] hover:from-[#C4A35A] hover:to-[#D4B06A] text-white font-bold rounded-xl transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 flex items-center gap-2">
                                        <span>Publicar</span>
                            ...
                            @if(Auth::user()->role_id == 4)
                                <p class="text-xs font-bold text-red-600 dark:text-red-400 mt-3 flex items-center justify-center gap-2">
